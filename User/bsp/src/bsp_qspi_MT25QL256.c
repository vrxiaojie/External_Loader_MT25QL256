...
*********************************************************************************************************
修改人:VRxiaojie
备注：基于https://www.armbbs.cn/forum.php?mod=viewthread&tid=101225&fromuid=58
已修改为适配MT25QL256ABA1EW9-0SIT的驱动模块 感谢硬汉大佬！

*/
#include "stm32h7xx_hal.h"
#include "stm32h7xx_hal_pwr.h"
#include "stm32h7xx_hal_qspi.h"
#include "bsp_qspi_MT25QL256.h"
...
int QSPI_EraseChip(void)
{
    ...
    sCommand.AddressMode = QSPI_ADDRESS_NONE;                     /* 地址发送无 */
    sCommand.Address = 0;                                           /* */
    sCommand.DataMode = QSPI_DATA_NONE;                             /* 无需发送数据 */
    sCommand.DummyCycles = 0;                                       /* 无需空周期 */
